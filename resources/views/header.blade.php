<header class="navbar navbar-expand-md bg-light navbar-light sticky-top px-3 py-0  border border-bottom ">
    ...
    <nav class="collapse navbar-collapse" id="content">
        <ul class="navbar-nav ms-auto me-auto">
            ...
            <div class="dropdown ms-md-5">
                <a class="nav-item nav-link  dropdown-toggle" href="#" role="button" id="" data-bs-toggle="dropdown" aria-expanded="false">
                  Dropdown link
                </a>
        ...
        <form action="" method="post">
            @auth
                <a href="{{ route('logout') }}" class="btn btn-primary ms-md-2 px-4 btn-sm d-none d-md-inline">Se deconnecter</a>
            @endauth
