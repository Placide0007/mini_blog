<template>
	<div class="d-flex justify-content-center align-items-center vh-100">
		<form @submit.prevent="login" method="post" class="RegisterFormWidth rounded bg-white shadow p-4">
			...
			<div v-if="errors.password" class="text-danger mb-2 small" >{{ errors.password }}</div>
